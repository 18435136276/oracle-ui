        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="请求参数：">
              <b-code-editor v-model="form.operParam" readonly theme="dracula" height="300px"></b-code-editor>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="返回参数：">
              <b-code-editor v-model="form.jsonResult" readonly theme="dracula" height="300px"></b-code-editor>
            </el-form-item>
          </el-col>
          <el-col :span="12">
